# Laravel Installer documentation

This folder documents the executable in this repository. It covers installer-specific behavior; Laravel application documentation remains at https://laravel.com/docs.
